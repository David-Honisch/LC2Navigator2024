...
;Version Information
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "LC2Navigator2025"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "LC2Navigator2025 Client x64"
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "LC2Navigator2025 x64"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "1.0.0"

;--------------------------------


Name "LC2Navigator2025"
Caption "LC2Navigator2025 Install (c)by http://www.letztechance.org"
Icon "${NSISDIR}\Contrib\Graphics\Icons\lc.ico"
OutFile "LC2Navigator2025install.exe"
...
InstallDir "$PROGRAMFILES\LETZTECHANCE.ORG\LC2Navigator2025"
InstallDirRegKey HKLM "Software\LETZTECHANCE.ORG\LC2Navigator2025" "LC2Navigator2025"
...
;	CreateShortCut "$SMPROGRAMS\$R0\All users LC2Navigator2025.lnk" $INSTDIR\LC2Navigator2025.exe
;Abort
;!else
...
;MessageBox MB_YESNO "Wollen Sie dieses Programm wirklich installieren ?" IDYES
  ...
  WriteRegStr HKLM SOFTWARE\WWW.LETZTECHANCE.ORG\LC2Navigator2025 "Install_Dir" "$INSTDIR"

  ; write uninstall strings
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2Navigator2025" "DisplayName" "LC2Navigator2025 (remove only)"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2Navigator2025" "UninstallString" '"$INSTDIR\uninst.exe"'
;---Extrahiere Dateien --------------------->
  SetOutPath $INSTDIR
  ;File /a "exe\LC2Navigator2025.exe"
  ;File /a "exe\*.*"
  File /a ".\install.zip"
...
SectionIn 1 4 3
  ...
  WriteRegStr HKLM SOFTWARE\LETZTECHANCE.ORG\LC2Navigator2025 "StrTest_INSTDIR" "$INSTDIR"
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2Navigator2025 "DwordTest_0xDEADBEEF" 0xdeadbeef
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2Navigator2025 "DwordTest_123456" 123456
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2Navigator2025 "DwordTest_0123" 0123
  WriteRegBin HKLM SOFTWARE\LETZTECHANCE.ORG\LC2Navigator2025 "BinTest_deadbeef01f00dbeef" "DEADBEEF01F00DBEEF"
;  StrCpy $8 "$SYSDIR\LC"
...
Section "CreateShortCuts"
 ...
 CreateDirectory $SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\LC2Start.NET.lnk" $INSTDIR\LC2Start.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\LC2Navigator2025.lnk" $INSTDIR\LC2Navigator2025.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\_LC2Launcher.lnk" $INSTDIR\LC2Navigator2025.exe
 ...
 CreateShortCut "$INSTDIR\LC2Navigator2025.exe.lnk" $INSTDIR\LC2Navigator2025.exe
 CreateShortCut "$DESKTOP\LC2Navigator2025.exe.lnk" $INSTDIR\LC2Navigator2025.exe
...
; CreateShortCut "$SMPROGRAMS\Startup\LC2Navigator2025.exe.lnk" "$INSTDIR\LC2Navigator2025-win32-ia32\LC2Navigator2025.exe"
 
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\AutoStart.lnk" $INSTDIR\LC2autostart.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\AutoStartConfig.lnk" $INSTDIR\LC2autostartConfig.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\AutoStartUninstall.lnk" $INSTDIR\LC2autostartUninstall.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\LC2Config.lnk" $INSTDIR\LC2Config.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\Uninstall.lnk" $INSTDIR\uninst.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\Support.lnk" $INSTDIR\letztechance.org.url
  SectionIn 1 2 3
...
CreateShortCut "$SMPROGRAMS\Startup\LC2Navigator2025.exe.lnk" $INSTDIR\LC2Navigator2025.exe
SectionEnd
...
UninstallText "Uninstall LC2Navigator2025 ?"
;UninstallIcon "${NSISDIR}\Contrib\Graphics\Icons\nsis1-uninstall.ico"
UninstallIcon "${NSISDIR}\Contrib\Graphics\Icons\lc.ico"

Section "Uninstall"

  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2Navigator2025"
  DeleteRegKey HKLM "SOFTWARE\WWW.LETZTECHANCE.ORG\LC2Navigator2025"

;  Delete "$SMPROGRAMS\WWW.LETZTECHANCE.ORG\LC2Navigator2025\reg\*.*"
...
;  File /a "exe\lc2sys.dll"
  ...
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\LC2Navigator2025.lnk"
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\uninst.lnk"
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2025\*.*"
